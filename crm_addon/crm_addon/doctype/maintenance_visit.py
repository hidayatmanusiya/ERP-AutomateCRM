...
def after_insert(doc,method):
	...
	subject = f"""Ticket created for Maintenance Visit {doc.name}"""
	customer_email= frappe.db.get_value("Customer", doc.customer, "email_id")
	client_body = f"""Dear Customer {doc.customer},
						Your appointment has been scheduled for failure product inspection on Date {doc.mntc_date} and Time {doc.mntc_time}.
	...
	frappe.msgprint("Maintenance Visit Ticket Creation Email Has Been Sent")
